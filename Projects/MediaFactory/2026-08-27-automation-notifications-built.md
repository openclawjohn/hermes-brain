# Media Factory — Automation + Notifications Built (2026-08-27)
...
18. **Added** PROJECT_STATE.md, DESIGN_SYSTEM.md, RULES.md.
...
- **Focused core scope** (per user): Programmes/Events + Campaign Planner + Content + CRM + Dashboard + design system + AI engine + Image Factory + Document Factory + Publishing Engine + Analytics + Automation + Notifications.

## Verification

- `manage.py check` passes.
- All 13 core routes HTTP 200.
...
- Remaining: Integrations (Postiz/WordPress), Knowledge Vault UI, System health dashboard.
