# Media Factory — Postiz Publishing Wired (2026-08-27)
...
21. **Wired real Postiz publishing** — scheduled a real post to Postiz (Facebook integration, returned real post ID `cmtbjtj26001tjt7gwd1jzo97`). Instagram requires media (image) which is expected.
...
- **Postiz publishing scheduled a real post** (Facebook integration, real post ID returned).
...
- Instagram publishing requires attaching media (image) — the Image Factory output can be wired to this.
