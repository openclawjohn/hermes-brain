# Media Factory — Publishing Engine + Analytics Built (2026-08-27)
...
16. **Added** PROJECT_STATE.md, DESIGN_SYSTEM.md, RULES.md.
...
- **Focused core scope** (per user): Programmes/Events + Campaign Planner + Content + CRM + Dashboard + design system + AI engine + Image Factory + Document Factory + Publishing Engine + Analytics.

## Verification

- `manage.py check` passes.
- All 24 key routes HTTP 200.
...
- Remaining: Automation rules, Notifications, Integrations (Postiz/WordPress), Knowledge Vault UI.
